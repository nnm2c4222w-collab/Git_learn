...
- **Repository (Repo / Kho lưu trữ):** Một thư mục dự án được quản lý hoàn toàn bằng Git. Gồm hai loại chính:
  - _Public:_ Ai cũng có thể xem và tải mã nguồn về.
  - _Private:_ Chỉ chủ sở hữu hoặc những người được phân quyền mới có thể truy cập.
...
## 2. Bản Đồ Quy Trình Quản Lý Tệp Tin (File Workflow)
...
## 3. Tổng Hợp Các Lệnh Git Cơ Bản
